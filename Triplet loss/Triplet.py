...
train_rest = np.concatenate((train_images[0][:15000,:,:,:] , train_images[1][:15000,:,:,:],train_images[3][:15000,:,:,:],train_images[4][:15000,:,:,:],train_images[5][:15000,:,:,:],train_images[6][:15000,:,:,:],train_images[7][:15000,:,:,:],train_images[8][:15000,:,:,:]))
print(train_rest.shape)

# train_dataset_1 = tf.data.Dataset.from_tensor_slices(train_images[0]).shuffle(BUFFER_SIZE).batch(BATCH_SIZE)
...
# train_dataset_4 = tf.data.Dataset.from_tensor_slices(train_images[3]).shuffle(BUFFER_SIZE).batch(BATCH_SIZE)
# train_dataset_5 = tf.data.Dataset.from_tensor_slices(train_images[4]).shuffle(BUFFER_SIZE).batch(BATCH_SIZE)
# train_dataset_6 = tf.data.Dataset.from_tensor_slices(train_images[5]).shuffle(BUFFER_SIZE).batch(BATCH_SIZE)
# train_dataset_7 = tf.data.Dataset.from_tensor_slices(train_images[6]).shuffle(BUFFER_SIZE).batch(BATCH_SIZE)
# train_dataset_8 = tf.data.Dataset.from_tensor_slices(train_images[7]).shuffle(BUFFER_SIZE).batch(BATCH_SIZE)
# train_dataset_9 = tf.data.Dataset.from_tensor_slices(train_images[8]).shuffle(BUFFER_SIZE).batch(BATCH_SIZE)
...
train_for_a_number(5 , EPOCHS , train_dataset_3 , train_dataset_rest)
